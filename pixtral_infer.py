...
class InferenceCLI:
    ...
    def _load_models(self):
        ...
        # )
        self.target = LlavaForConditionalGeneration.from_pretrained(
            target_model,
            #quantization_config=target_quantize,
            torch_dtype=torch.float16,
            device_map=self.device,
        ...
        self.tokenizer = AutoProcessor.from_pretrained(tokenizer_name, trust_remote_code=True)
        ...
        #     trust_remote_code=True,
        # )
        self.drafter = LlavaForConditionalGeneration.from_pretrained(
            drafter_model,
            #quantization_config=drafter_quantize,
            torch_dtype=torch.float16,
            device_map=self.device,
